...
const FamilyProfile = ({ userType = 'patient' }) => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>ملف العائلة الطبي - نظام المواعيد الطبية</title>
        <meta
          name="description"
          content="إدارة المعلومات الشخصية والطبية لأفراد عائلتك بسهولة وفعالية. أضف، عدل، أو احذف بيانات أفراد العائلة."
        />
        <meta name="keywords" content="ملف العائلة, إدارة المرضى, نظام عيادة, بيانات طبية, برمجيات طبية" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="نظام إدارة العيادات" />
        <meta property="og:title" content="ملف العائلة الطبي - نظام المواعيد الطبية" />
        <meta
          property="og:description"
          content="نظام متقدم لإدارة بيانات أفراد العائلة الطبية، يتيح إضافة وتعديل وحذف سجلات أفراد العائلة بسهولة."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:locale" content="ar_EG" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="ملف العائلة الطبي - نظام المواعيد الطبية" />
        <meta
          name="twitter:description"
          content="إدارة بيانات أفراد العائلة الطبية بسهولة وفعالية مع نظام المواعيد الطبية."
        />
      </Helmet>
      ...
      <div className="profile-header-section">
        <motion.h1 initial={{ y: -20 }} animate={{ y: 0 }} transition={{ duration: 0.4 }}>
                ...
                <div className="image-upload-container">
                  ...
                  {currentMember.image && (
                    <div className="image-preview">
                      <img src={currentMember.image} alt="Preview" className="preview-image" />
                      <button
                    ...
                    <motion.button
                      ...
                      onClick={() => {
                        setCurrentMember(prev => ({
                          ...
                          relation: rel.value,
                          gender:
                            rel.value === 'ابنة' || rel.value === 'زوجة' || rel.value === 'أم' ? 'female' : 'male',
                        }));
                      }}
                        ...
                        >
                          <div className="card-header">
                            ...
                            <div className="member-main-info">
                              ...
                              <div className="member-relation-badge">{member.relation}</div>
                            </div>
                            <button className="view-member-btn" onClick={() => handleViewMember(member)}>
                              <FaEye />
                            </button>
                          </div>
                          ...
                          {member.image && (
                            <div className="member-card-image">
                              <img src={member.image} alt={member.fullName} className="card-image" />
                            </div>
                          )}
                          ...
                          <div className="card-body">
                            ...
                            {member.additionalNotes && (
                              <div className="info-row notes-row">
                                <span>ملاحظات:</span>
                                <div className="notes-content">{member.additionalNotes}</div>
                              </div>
                            )}
                          </div>
