          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 text-right bg-white/90 ${formik.touched.name && formik.errors.name
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 text-right bg-white/90 ${formik.touched.address && formik.errors.address
                  ? "border-red-500 focus:ring-red-500"
                  : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-1 text-right bg-white/90 ${formik.touched.phone && formik.errors.phone
                  ? "border-red-500 focus:ring-red-500"
                  : "border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                  }`}
              />
