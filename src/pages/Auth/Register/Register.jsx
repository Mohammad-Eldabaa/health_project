...
export default function Register() {
    ...
    const state = [
        "البحيرة", "الإسكندرية", "الغربية", "الإسماعيلية", "الأقصر", "البحر الأحمر",
        "الجيزة", "الدقهلية", "السويس", "الشرقية", "الفيوم", "القاهرة", "القليوبية",
        "المنوفية", "المنيا", "الوادي الجديد", "بني سويف", "بورسعيد", "أسيوط",
        "جنوب سيناء", "دمياط", "سوهاج", "شمال سيناء", "قنا", "كفر الشيخ", "مطروح", "أسوان",
    ];
                        ...
                        <div className="form-container text-end mx-auto">
                            <Form onSubmit={formik.handleSubmit}>
                                ...
                                <div className="text-center mt-2">
                                    <Button variant="primary" type="submit">سجل الآن</Button>
                                </div>

                                <div className="text-center mt-2">
                                    <p>
                                        لديك حساب بالفعل؟{' '}
                                        <NavLink href="/" className="text-primary fw-bold">سجل الدخول</NavLink>
                                    </p>
                                </div>
                            </Form>
                        </div>
