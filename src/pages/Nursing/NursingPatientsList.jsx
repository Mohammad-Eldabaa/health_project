    ...
    <div className="container-fluid min-vh-100 p-0" dir="rtl">
      <div className="row g-0">
        ...
        >
          ...
          <div className="patients-container mt-3">
            <div className="patients-title">المرضى</div>
            <div className="patients-table-container bg-gray-100 p-4 rounded-lg shadow-md">
              <div className="search-inputt"></div>

              {/* Desktop Table View */}
              <div className="bg-white p-4 rounded-2xl hidden md:block w-full">
                        ...
                        <td>
                          <span
                            className={`status-badge ${
                              patient.status === "مستقر"
                                ? "stable"
                                : patient.status === "حالة متوسطة"
                                ? "moderate"
                                : "critical"
                            }`}
                          >
