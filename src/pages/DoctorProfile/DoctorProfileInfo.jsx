  ...
  return (
    <>
      ...
      <div className="relative flex flex-col items-center p-6">
        ...
        {editMode && (
          <motion.label
            className="absolute bottom-4 right-10 md:right-24 bg-[#006064] text-white w-10 h-10 rounded-full flex items-center justify-center cursor-pointer shadow-md hover:bg-[#00838F] transition-all"
