    ...
    return (
        ...
        >
            ...
            <div className="flex gap-4">
                <motion.button
                    className={`flex items-center gap-2 px-6 py-3 rounded-lg ${editMode ? 'bg-white text-[#0097A7] hover:bg-gray-100' : 'bg-[#006064] hover:bg-[#00838F]'} font-medium transition-all hover:shadow-md`}
