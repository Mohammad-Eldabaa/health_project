        ...
        <div className="p-5 bg-white min-h-screen rtl">
                                ...
                                <tr key={test.id} className={selectedTests.includes(test.id) ? 'bg-blue-50 border-t border-gray-300 text-center' : 'border-t border-gray-300 text-center'}>
                                    ...
                                    <td className="p-4">
                                        <div className="flex justify-center">
                                            ...
                                            <button className="text-cyan-500 hover:bg-cyan-50 p-2 rounded-full"><Edit /></button>
                                            <button className="text-red-900 hover:bg-red-50 p-2 rounded-full"><Delete /></button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
            ...
            {selectedTests.length > 0 && (
                <div className="flex flex-wrap gap-4 justify-between items-center bg-gray-50 p-4 rounded-xl shadow my-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <button className="flex items-center gap-1  px-2 py-2 rounded-md text-white bg-teal-500"><Add /> إضافة</button>
                        <button className="flex items-center gap-1  px-2 py-2 rounded-md text-white  bg-cyan-500"><Print /> طباعة</button>
