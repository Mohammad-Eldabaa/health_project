                ...
                <div className="rounded-xl shadow-sm p-4 bg-gray-100">
                    ...
                    <div className="space-y-6 bg-white p-6 rounded-lg shadow">
                            ...
                            <div className="md:w-1/3">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-2">
                                        <button className="text-sm text-cyan-600 hover:text-cyan-800 block">
                                            تغيير الصورة
                                        </button>
                        ...
                        <div className="flex justify-end">
                            <button className="px-6 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-800 transition">
                                حفظ التغييرات
                            </button>
                        </div>
                    </div>
