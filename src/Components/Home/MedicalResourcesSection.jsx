                        ...
                        >
                            <div className="p-8 md:p-10 flex flex-col md:flex-row">
                                ...
                                <div className="md:w-3/4 md:pr-4">
                                    <h3 className="text-2xl font-bold text-[#0097A7] mb-3">
                                        {resource.title}
                                    </h3>
                                    ...
                                    <ul className="grid grid-cols-2 gap-2 mb-6">
                                        {resource.features.map((feature, i) => (
                                            <li key={i} className="flex items-start">
                                                <span className={`w-2 h-2 rounded-full mt-2 mr-2 ${index === 0 ? 'bg-[#009688]' : 'bg-[#009787]'}`}></span>
                                    ...
                                    <motion.a
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        href={resource.link}
                                        className={`inline-flex items-center rounded-md border-1 p-2 ${index === 0 ? 'text-[#009688]' : 'text-[#009688]'} font-semibold`}
                                    >
