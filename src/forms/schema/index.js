...
export const logInAndRegisterSchema = yup.object({
    name: yup.string().required('الاسم مطلوب').min(3, 'الاسم يجب أن يكون على الأقل 3 أحرف'),
    email: yup.string().email('البريد الإلكتروني غير صالح').required('البريد الإلكتروني مطلوب'),
    password: yup.string().required('كلمة المرور مطلوبة').min(6, 'كلمة المرور يجب أن تكون على الأقل 6 أحرف'),
